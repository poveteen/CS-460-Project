...
class KerasRunner(Runner):
    def __init__(self, model_name: str):
        ...
        from tensorflow.python.keras.backend import set_session # ISSUE 88 - Initially was not a part
        self.sess = tf.Session() # ISSUE 88 - Initially was not a part
        set_session(self.sess) # ISSUE 88 - Initially was not a part
